...
PAGES = [
    ...
    dict(slug="reviews", crumb="Reviews",
         title="Guest Reviews — Denver Elysium · Akright City, Bwebajja",
         desc="Read what guests say about Denver Elysium — spotless apartments, a warm welcome, the indoor pool and an unbeatable spot near Entebbe Airport. Rated 5.0★.",
         og="Loved by Guests — Denver Elysium Reviews"),
...
def build_page(p):
    ...
    mid = mid.replace("this.onerror=null;this.src=this.dataset.fallback",
                      "this.onerror=null;this.removeAttribute('srcset');this.loading='eager';this.src=this.dataset.fallback")
